...
$sql = "SELECT karyawan.id_karyawan, karyawan.nama_karyawan, detail_jabatan.nama_jabatan, unit_kerja.nama_unit_kerja
FROM karyawan
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modal-default-edit-<?php echo $baris['id_karyawan']; ?>">
                                                            <i class="nav-icon fas fa-edit"></i> Edit
                                                        </a>
                                                        <!-- modal tambah edit -->
                                                        <?php
                                                        $id_edit = $baris['id_karyawan'];
                                                        $sql_ngedit = "SELECT karyawan.id_karyawan, karyawan.nama_karyawan, detail_jabatan.nama_jabatan, unit_kerja.nama_unit_kerja
                                                                        FROM karyawan
                                                                        INNER JOIN jabatan ON karyawan.jabatan_id = jabatan.id_jabatan
                                                                        INNER JOIN detail_jabatan ON jabatan.detail_jabatan_id = detail_jabatan.id_detail_jabatan
                                                                        INNER JOIN unit_kerja ON jabatan.unit_kerja_id = unit_kerja.id_unit_kerja
                                                                        WHERE karyawan.id_karyawan = $id_edit";
                                                        $data = mysqli_query($koneksi, $sql_ngedit);
                                                        $row = mysqli_fetch_assoc($data);
                                                        ?>
                                                        <div class="modal fade" id="modal-default-edit-<?php echo $baris['id_karyawan']; ?>">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="widgets.php" method="post">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="nama_karyawan" placeholder="Masukkan Nama Karyawan" name="nama_karyawan" value="<?php echo $row["nama_karyawan"]; ?>">
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="form-control" name="detail_jabatan">
                                                                                    ...
                                                                                    $hasil0 = mysqli_query($koneksi, $sql_detail_jabatan1);
                                                                                    while ($row_detail_jabatan = mysqli_fetch_assoc($hasil0)) {
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="form-control" name="unit_kerja">
                                                                                    <?php
                                                                                    $sql_ukerja0 = "SELECT * FROM unit_kerja";
                                                                                    $hasil9 = mysqli_query($koneksi, $sql_ukerja0);
                                                                                    while ($row_ukerja3 = mysqli_fetch_assoc($hasil9)) {
                                                                                        echo "<option value='" . $row_ukerja3['id_unit_kerja'] . "' ";
                                                                                        if ($row['nama_unit_kerja'] == $row_ukerja3['nama_unit_kerja']) echo 'selected';
                                                                                        echo ">" . $row_ukerja3['nama_unit_kerja'] . "</option>";
                                                                                    }
                                                                                    ?>
                                                                                </select>
                                                                            </div>
                                                                            ...
                                                                            <input type="hidden" name="id_karyawan" value="<?php echo $baris["id_karyawan"]; ?>">
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-default-hapus-<?php echo $baris['id_karyawan']; ?>">
                                                            <i class="nav-icon fas fa-trash"></i> Delete
                                                        </a>
                                                        <!-- modal tambah edit -->
                                                        <form action="widgets.php" method="post">
                                                            <div class="modal fade" id="modal-default-hapus-<?php echo $baris['id_karyawan']; ?>">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <input type="hidden" name="id_absen" value="<?php echo $baris["id_karyawan"]; ?>">
                                                                        </div>
                                                                        <div class="modal-footer justify-content-between">
                                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
